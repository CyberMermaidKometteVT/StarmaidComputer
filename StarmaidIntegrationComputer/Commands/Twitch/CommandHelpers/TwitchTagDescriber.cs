...
namespace StarmaidIntegrationComputer.Commands.Twitch.CommandHelpers
{
    internal static  class TwitchTagDescriber
    {
        ...
        private static IReadOnlyList<string> exactQueerLabels = new List<string> { "LGBTQIAPLUS", "QUEER", "LESBIAN", "GAY", "GAYMER", "BISEXUAL", "BI", "PANSEXUAL", "INTERSEX", "ACE", "ASEXUAL", "AROMANTIC", "GRAYACE", "GREYACE", "GENDERFLUID", "TRANSBIAN", "NONBINARY", "ENBY", "NB", "GENDERSPICY", "FRIENDOFDOROTHY", "FRIENDOFMARA" }.AsReadOnly();
