...
namespace StarmaidIntegrationComputer.Commands.Twitch.CommandHelpers
{
    ...
    {
        private static IReadOnlyList<string> exactQueerLabels = new List<string> { "LGBTQIAPLUS", "LGBT", "LGBTQ", "LGBTQIA", "LGBTQIA+", "QUEER", "LESBIAN", "GAY", "GAYMER", "BISEXUAL", "BI", "PANSEXUAL", "INTERSEX", "ACE", "ASEXUAL", "AROMANTIC", "GRAYACE", "GREYACE", "GENDERFLUID", "TRANSBIAN", "NONBINARY", "ENBY", "NB", "GENDERSPICY", "FRIENDOFDOROTHY", "FRIENDOFMARA" }.AsReadOnly();
        private static IReadOnlyList<string> transLabels = new List<string> { "TRANSGENDER", "TRANSBIAN", "TRANSMAN", "TRANSWOMAN", "TRANS" }.AsReadOnly();
